...
type global_metadata = {
  ...
  esproposal_optional_chain: Options.esproposal_feature_mode;
...
module Global = struct
  ...
  let esproposal_optional_chain t = t.metadata.esproposal_optional_chain
...
let global_metadata_of_options options = {
  ...
  esproposal_optional_chain = Options.esproposal_optional_chain options;
...
let esproposal_optional_chain cx = Global.esproposal_optional_chain cx.global
